...
public class Eventmanagerprofile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eventmanagerprofile);
    ...
    public void Reload(View v) {
        ...
        if (name.equals("") || phone.equals("") || password.equals("") || email.equals("") || dept.equals("") || userid.equals("")) {
            ...
            try {
                ...
                Intent i = new Intent(Eventmanagerprofile.this, Studentlogin.class);
                startActivity(i);
                Toast.makeText(getApplicationContext(), returnedstring, Toast.LENGTH_LONG).show();
                if (returnedstring.equals("false")) {
                    Intent s = new Intent(Eventmanagerprofile.this, Studentlogin.class);
                    startActivity(s);
